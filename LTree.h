...
public:  ////
     ...
     */
    LInternalNode::Entry findLeaf(unsigned long, std::vector<LNesbo> *path = nullptr);

    LInternalNode::Entry findLeaf2(unsigned long, std::vector<LNesbo> &);
     ...
     */
    bool access(unsigned long, std::vector<LNesbo> *path = nullptr);
     ...
     */
    bool setBit(unsigned long, bool, std::vector<LNesbo> *path = nullptr);
     ...
     */
    LTree *insertBlock(long unsigned, std::vector<LNesbo> *path = nullptr);
     ...
     * @return the new root if the tree's root changed, nullptr otherwise
     */
    LTree *deleteBlock(long unsigned, std::vector<LNesbo> *path = nullptr);
...
private:
     ...
     */
    LTree *
    insertBits(long unsigned, long unsigned, std::vector<LNesbo> *path = nullptr);
     ...
     */
    LTree *
    deleteBits(long unsigned, long unsigned, std::vector<LNesbo> *path = nullptr);
