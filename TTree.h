...
public:
     ...
     */
    InternalNode::Entry findLeaf(unsigned long, std::vector<Nesbo> *path = nullptr);

    InternalNode::Entry findLeaf2(unsigned long, std::vector<Nesbo> &);
     ...
     */
    unsigned long rank1(unsigned long, std::vector<Nesbo> *path = nullptr);
     ...
     */
    bool access(unsigned long, std::vector<Nesbo> *path = nullptr);
     ...
     */
    bool setBit(unsigned long, bool, std::vector<Nesbo> *path = nullptr);
     ...
     */
    TTree *insertBlock(long unsigned, std::vector<Nesbo> *path = nullptr);
     ...
     * @return the new root if the tree's root changed, nullptr otherwise
     */
    TTree *deleteBlock(long unsigned, std::vector<Nesbo> *path = nullptr);
...
private:
     ...
     */
    TTree *
    insertBits(long unsigned, long unsigned, std::vector<Nesbo> *path = nullptr);
     ...
     */
    TTree *
    deleteBits(long unsigned, long unsigned, std::vector<Nesbo> *path = nullptr);
